...
**edit** turhia alalukuja pois, datan luku tekniikkaliitteessä ja/tai johdantoluvussa
lyhyesti. Löytyy koodista ja Githubista. Tässä otsikot vain markkereita koodilohkoille.

## Data: kuka, missä, milloin?
**ks** ISSP, linkit, ihan ensimmäisenä yhteiskunatieteellinen tietoarkisto.

**ks** ISSP, GESIS

**ISSP 2012**, linkit dokumentaatioon eivät oiken toimi.


**ks** 

Datan luku ja perusmuokkaukset selostettu R-koodissa (liittenä).
...
*
*edit** Voiko/saako
tekstissä olla linkkejä?

ISSP-viitteiden testailua:


"ISSP - saitilla" löytyy bibliografia, ja hakupalveluillakin voi haravoida.
**zxy** www.gesis.org - sivustolta löytyy myös
[julkaisuluettelo](https://search.gesis.org/research_data/ZA5900).

 

**k** ISSP (International social survey) on tehnyt laajoja kansainvälisiä
kyselytutkimuksia eri teemoista. Yksi teemoista on perhe ja muuttuvat
(sosiaalisesti määräytyvät) sukupuoliroolit.

Viitteet ISSP2012 - dokumentteihin:

Tutkimuksen viitetieto, linkki vie dokumenttiluetteloon koska hanke on päättynyt.
Kaksi versiota, käytetään ensimmäistä [@RefWorks:doc:5b6c7b0de4b0fd36f5bb4c2a] . 
Toisessa suora linkki, huono juttu. [@RefWorks:doc:5b6c7debe4b0e4e15164ab00].
Data ja dokumentaatio (ml. käyttöehdot) löytyvät GESIS-instituutin datakatalogista
[@RefWorks:doc:5b6c7f6ce4b0e4e15164ab1a].

Koodikirjan ("variable report") [@RefWorks:doc:5bb9041be4b06677e5e61f83] selostaa
tarkasti tietosisällön, tutkimuksen seurantaraportti
...
suomenkielinen versio [@RefWorks:doc:5bb90a0ae4b018435936a488]. Tiedonkeruun
tarkoitus ja kyselyn suunnitelun ideat kerrotaan omassa raportissa
[@RefWorks:doc:5f9439fde4b04741789a2187].

**edit 9.11.20** Kaikki linkit vievät vain GESIS-arkistosivulle jossa on "pitkähkö"
lista pdf-dokumentteja. Siksi tässä taulukkona tärkeimpien dokumenttien
tiedostonimet.
...
**zxy** Miksi data sovelutuu korrespondenssianalyysin esittelyyn? Iso ja
monimutkainen (kansainvälinen, datan laaut? kts. Blasius-viite alempana),
sisällölliset muuttuja nominaaliasteikolla (kysymyspatterit, Likert),
laadukas hyvin dokumentoitu aineisto.

**zxy** Onko itse asia kiinnostava? (Kantolan kolumni, HS), The Econimist?
...
**edit 8.11.20** Nämä sitaatit kuuluvat muualle, viitteet voivat olla. Näitä
viitteitä vähän liian monessa paikassa!

Michael Greenacre on käyttänyt aineistoa eri vuosilta luentomateriaaleissa
(Helsinki 2017 MCA, viite Moodleen?) ja kahdessa oppikirjassa
([@RefWorks:doc:5a857a43e4b0ed2d44664d7c], [@RefWorks:doc:5a857a43e4b0ed2d44664d78]).
ISSP - aineisto vuodelta 1989 on käytetty myös neljän "singuaariarvohajoitelmaan
perustuvan menetelmän" vertailuun[@RefWorks:doc:5b6f159ce4b0bc0f31734b76]. 

Blasius ja Thiessen ([@RefWorks:doc:5b15542ee4b0e2616bc42dca]) arvioivat aineiston
...
**tärkeä rajaus** Substanssitutkimusta ei tässä käsitellä. Siksi muutama esimerkki.
...
Toisessa esimerkissä [@RefWorks:doc:5bd0a663e4b0c91dcf7c4be9] tutkitaan ensin 18
