...
**edit** turhia alalukuja pois, datan luku tekniikkaliitteessä ja/tai
johdantoluvussa lyhyesti. Löytyy koodista ja Githubista.
Tässä otsikot vain markkereita koodilohkoille.
...
**edit** vain varmistuksena toistaikseksi
...
## Data: kuka, mitä, missä ja milloin
...
**ks** ISSP, GESIS historiaa


**ks** "Perhe, työ ja sukupuoliroolit" tutkimuksen teemat, tarkoitus.
**Paras** lähde Yhteiskuntatieteellisen tietoarkiston palvelu
(https://services.fsd.uta.fi/catalogue/FSD2820?tab=summary&study_language=fi).


ISSP2012-viitteiden testailua:
...
datakatalogista (https://zacat.gesis.org)[@RefWorks:doc:5b6c7f6ce4b0e4e15164ab1a].
...
**edit 9.11.20** Kaikki linkit lähdeluettelossa vievät vain GESIS-arkistosivulle,
...
**zxy** Miksi data on kiinnostava sisällöllisesti? Viite Kantola (HS). Lisäksi
laadukas, usealta vuodelta, tarkasti dokumentoitu.
...
**zxy** Onko itse asia kiinnostava? (Kantolan kolumni, HS), The Economist?
