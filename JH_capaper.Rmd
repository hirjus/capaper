...
date: "Versio 0.65, tulostettu `r Sys.Date()`"
output: pdf_document
...
(https://www.diw.de/de/diw_01.c.799302.de/publikationen/weekly_reports/2020_38_1/mothers_in_eastern_and_western_germany__employment_rates_and_attitudes_are_converging__full-time_employment_is_not.html)
...
Rivipisteet ja sarakepisteet yhdistää _barysentrinen_periaate_ . Jokainen rivipiste
...
plot(maagaCA2sub2, main = "Q1b: Lapsi kärsii jos äiti käy töissä",
     sub = "symmetrinen kartta - Tanska, Saksa ja Suomi (subset ca), cex = 0.8")
