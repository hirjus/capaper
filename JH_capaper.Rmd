...
[@RefWorks:doc:5c0543a5e4b077eba1dc3cd8].
...
tutkimuksen periaatteita (McNamara ja Horton [@RefWorks:doc:5c3759c2e4b0085b307c82b5] ),
...
**k** **edit** Tulkinta on aika hankalaa, ehkä riittää että toteaa selvän
...
**k** kokeilu 3d-grafiikalla - toinen riittää. Dynaamisella kuvalla pistepilvien
...
**edit** numeerisia tuloksia ei listata lopullisessa raportissa.
...
**k2** Kuvien luettavuus ja pistekoko, hankala juttu

**k** Kuvien järjestyksen perustelu. 1. symmetrinen, voidaan arvioida rivipisteiden
ja sarakepisteiden etäisyyksiä. Akselien tulkinta.

2. Kontribuutikartta: laatu, tulkinnan tarkentaminen

3. Rivipisteiden etäisyydet - siksak
