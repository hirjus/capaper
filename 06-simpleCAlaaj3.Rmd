...
sentroidi säilyy kartan keskipisteenä. Osajoukkojen inertioiden summa on koko
aineiston inertia.
...
huonosti. Kaksi dimensiot selittävät osajoukon kokonaishajonnasta 92 prosenttia, mutta muutaman
...
dimensioille projisoidut sarakepisteet ovat odotetussa järjestyksessä.
...
Belgian, Unkarin ja Bulgarian kartalla ensimmäisen dimension tulkinta
...
yleiskuvaa (ks. Kuva \@ref(fig:maagaCA1map1)).
