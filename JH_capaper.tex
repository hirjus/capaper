...
\date{Versio 0.3, tulostettu 2020-10-26}
...
\chapter{Korrespondenssianalyysin laajennuksia 3 - osajoukon CA}\label{korrespondenssianalyysin-laajennuksia-3---osajoukon-ca}}
...
\textbf{k} Subset-CA:n vaihtoehdot
...
\textbf{edit} seuraava luku MCA subset.
...
\CommentTok{# TÄSSÄ EHKÄ VIRHE (26.10.20)?}
...
\KeywordTok{write_rds}\NormalTok{(suppoint1_tab1,}\StringTok{"suppoint1tab1.rds"}\NormalTok{)}
\CommentTok{# riviprofiilitaulukko aiheuttaa virheen PDF-tulostuksessa }
\CommentTok{# }
\CommentTok{#kokeilu - tallennetaan data tiedostoon, koodilohko BeDeAluedat1 passiviseksi}

\NormalTok{suppoint1_tab1 <-}\StringTok{ }\KeywordTok{read_rds}\NormalTok{(}\StringTok{"suppoint1tab1.rds"}\NormalTok{)}
