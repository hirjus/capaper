...
\date{Versio 0.8, tulostettu 2020-11-24}
...
korrespondenssianalyysin keskeinen idea (CAiP, s. 57). Rivi- ja sarakeongelma
ratkaisu johtaa saamaan lopputulokseen.

Ratkaisun dimensio on sarakkeiden tai rivien lukumäärä vähennettynä yhdellä,
pienempi kahdesta vaihtoehdosta.

Korrespondenssianalyysi on oleellisesti pääkomponenttianalyysiä, etäisyysmitta on
...
\textbf{Matched matrices} \textbf{edit} Ei omaa lukua, vaan pari kappaletta matriisien pinoamisesta
ja yhdistelystä.
...
\textbf{k}Idea: matriisien yhdistämisellä
...
\textbf{TÄHÄN VOISI LOPETTAA - EI KAHTA PITÄÄ TULOSTETTA KUN NIITÄ EI TARKEMMIN ANALYSOIDA}
