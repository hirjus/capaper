...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# testaukseen 7.11.2020}
...
\NormalTok{suppoint2_tab1 }\CommentTok{# tarkistus 1}
\CommentTok{# Huom! tämä komento vain kerran - tai koko Rmd-tiedosto uudestaan (17.10.20)}
\NormalTok{suppoint2_tab1 <-}\StringTok{ }\NormalTok{suppoint2_tab1[}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{4}\OperatorTok{:}\DecValTok{6}\NormalTok{) ,]}
...
\NormalTok{suppoint1_tab1 }\CommentTok{# tarkistus 3}
...
\KeywordTok{dim}\NormalTok{(MCAdata1jh.dat)}
\KeywordTok{names}\NormalTok{(MCAdata1jh.dat)}
...
\NormalTok{MCAdata1jh.dat }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{tableX}\NormalTok{(maa,age_cat,}\DataTypeTok{type =} \StringTok{"count"}\NormalTok{) }\CommentTok{#%>%}
        \CommentTok{#kable(digits = 2, caption = "Ikäluokka age_cat")}

\NormalTok{MCAdata1jh.dat }\OperatorTok{%>%}
\StringTok{        }\KeywordTok{tableX}\NormalTok{(maa,age_cat,}\DataTypeTok{type =} \StringTok{"row_perc"}\NormalTok{) }\CommentTok{#%>%}
        \CommentTok{#kable(digits = 2, caption = "age_cat: suhteelliset frekvenssit")}
...
\KeywordTok{str}\NormalTok{(ISSP2012jh1d.dat}\OperatorTok{$}\NormalTok{sosta)}
\KeywordTok{str}\NormalTok{(ISSP2012jh1d.dat}\OperatorTok{$}\NormalTok{urbru)}
\KeywordTok{str}\NormalTok{(ISSP2012jh1d.dat}\OperatorTok{$}\NormalTok{edu)}
...
\KeywordTok{names}\NormalTok{(MCAdata1jh.dat)}
\KeywordTok{dim}\NormalTok{(MCAdata1jh.dat)}
\NormalTok{MCAdata1jh.dat}\OperatorTok{$}\NormalTok{E }\OperatorTok{%>%}\StringTok{ }\KeywordTok{levels}\NormalTok{()}
\NormalTok{MCAdata1jh.dat}\OperatorTok{$}\NormalTok{S }\OperatorTok{%>%}\StringTok{ }\KeywordTok{levels}\NormalTok{()}
\NormalTok{MCAdata1jh.dat}\OperatorTok{$}\NormalTok{U }\OperatorTok{%>%}\StringTok{ }\KeywordTok{levels}\NormalTok{()}
\NormalTok{MCAdata1jh.dat}\OperatorTok{$}\NormalTok{age_cat }\OperatorTok{%>%}\StringTok{ }\KeywordTok{levels}\NormalTok{()}
\KeywordTok{str}\NormalTok{(MCAdata1jh.dat}\OperatorTok{$}\NormalTok{ga) }\CommentTok{# toimiikohan - chr-muuttuja? (16.10.20)}

\NormalTok{MCAdata1jh.dat <-}\StringTok{ }\NormalTok{MCAdata1jh.dat }\OperatorTok{%>%}
\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{gaf =} \KeywordTok{as_factor}\NormalTok{(ga))}

\KeywordTok{str}\NormalTok{(MCAdata1jh.dat}\OperatorTok{$}\NormalTok{gaf)}
\KeywordTok{levels}\NormalTok{(MCAdata1jh.dat}\OperatorTok{$}\NormalTok{gaf) }\CommentTok{# järjestyksellä ei liene väliä? (16.10.20)}
