...
Kuvan perusteella ei voi sanoa kuinka paljon, kaikki erot ovat suhteellisia.
...
En jatkossa esitä kuvailevia akseleiden nimiä kuvissa, akseleiden nimeäminen on
kuvan tulkinnan perusta.


**edit - onko tarpeen?** 
Ratkaisun idea on aivan sama kuin pääkomponenttianalyysissä
...
moniulotteiselle datalle, yleensä kaksiulottoinen kartta. CA on paintotettu PCA.
...
käytetyn R-paketin oletus. Siinä molemmat pisteparvet on esitetty
...
dimensioon. Toista dimensiota määrittää vahviten e, mutta myös kaikki muut
