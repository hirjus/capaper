...
**k1** Korrespondenssianalyysin geometriset periaatteet ja kuvien tulkinnan
...
**k2** Yksinkertainen korrespondenssianalyysi on yhden taulukon analyysiä.
...
**edit**  Tässä esitellään ovelasti CA:n tripletin kaksi jäsentä, massat ja profiilit.
...
**k** Prosentit - kuinka paljon kokonaisinertiasta saadaan kuvattua ("selitettyä") kahdessa
...
**k** Miksi symmetrinen kartta on paras oletus?