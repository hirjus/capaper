...
**edit** Tiivisti tärkeimmät käyttötapaukset. CA:n peruskäsitteet ja numeeriset
...
# Korvattu maa-faktorin tyhjien luokkien poisolla (14.11.2020)
...
plot(suppointCA2, main = "kontribuutiokartta 1",
        map = "rowgreen",
        arrows = c(FALSE, TRUE),
        mass = c(TRUE, FALSE),
