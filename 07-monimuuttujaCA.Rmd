...
```{r concat1map1,fig.cap= "Q1b: Lapsi kärsii jos äiti käy työssä", fig.asp = 1, out.width = "90%",fig.align = "center"}
...
**edit: karttojen otsikot tarkistettava**
...
**TÄHÄN VOISI LOPETTAA - EI KAHTA PITKÄÄ TULOSTETTA KUN NIITÄ EI TARKEMMIN ANALYSOIDA** 
