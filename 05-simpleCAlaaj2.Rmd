...
soluissa on sentää viisi havaintoa tai enemmän. Pienten massojen profiilen ja harvinaisten
...
kokonaisinertiasta. Dimensioiden tulkinta on suurinpiirtein sama kuin kuin
...
konservatiisimpia ovat oikeassa laidassa Unkari ja Bulgaria. Toisella
...
Numeeristen tulosten taulukko on pitkä, mutta kartan informaatio pitää varmistaa.
...
piirteet datassa. Regeressiomallien tulosten raporteissa diagnostiikka on usein
...
tapauksesa esitettyä paljon tiiviimmin.
...
Sarakkeet on kohtailaisen hyvin esitetty, heikoimmin neutraali vaihtoehto (qlt = 535).
...
absoluuttiset kontribuutiot ovat lähes pelkästään toiselle dimenisolle maltilliseen
...
En data-analyysissä löytänyt kartan \@ref(fig:maagaCA1map1) numeerisista
tuloksista pienen massan pisteitä joilla on merkittävä kontribuutio akseleihin.
